...
public:
    ...
    NestedClassProxy(): NestedClassProxy(nullptr, nullptr) {}
    ...
    NestedClassProxy(NestedClassProxy&& from) noexcept
           : mJniEnv(from.mJniEnv), mJavaObjectReference(from.mJavaObjectReference) {
        from.mJavaObjectReference = nullptr;
    }
    
    NestedClassProxy& operator=(NestedClassProxy&& from) noexcept {
