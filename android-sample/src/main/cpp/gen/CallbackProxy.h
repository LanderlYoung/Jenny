...
private:
    ...
    static jfieldID sField_count_2;
    static jfieldID sField_staticName_3;
    static jfieldID sField_aStaticField_4;
    static jfieldID sField_name_5;
    static jfieldID sField_lock_6;
    static jfieldID sField_staticCount_7;
...
public:
    ...
    void onJobProgress(jlong progress) const {
        mJniEnv->CallVoidMethod(mJavaObjectReference, sMethod_onJobProgress_3, progress);
    }


    // field:  final int ANOTHER_COMPILE_CONSTANT_INT
    void setANOTHER_COMPILE_CONSTANT_INT(jint ANOTHER_COMPILE_CONSTANT_INT) const {
        mJniEnv->SetIntField(mJavaObjectReference, sField_ANOTHER_COMPILE_CONSTANT_INT_0, ANOTHER_COMPILE_CONSTANT_INT);
    }


    // field:   int count
    jint getCount() const {
       return mJniEnv->GetIntField(mJavaObjectReference, sField_count_2);

   }
    // field:   int count
    void setCount(jint count) const {
        mJniEnv->SetIntField(mJavaObjectReference, sField_count_2, count);
    }

    // field: static  java.lang.String staticName
    jstring getStaticName() const {
       return reinterpret_cast<jstring>(mJniEnv->GetStaticObjectField(sClazz, sField_staticName_3));

   }
    // field: static  java.lang.String staticName
    void setStaticName(jstring staticName) const {
        mJniEnv->SetStaticObjectField(sClazz, sField_staticName_3, staticName);
    }

    // field: static  java.util.List<java.lang.String> aStaticField
    jobject getAStaticField() const {
       return mJniEnv->GetStaticObjectField(sClazz, sField_aStaticField_4);

   }
    // field: static  java.util.List<java.lang.String> aStaticField
    void setAStaticField(jobject aStaticField) const {
        mJniEnv->SetStaticObjectField(sClazz, sField_aStaticField_4, aStaticField);
    }
    ...
    // field:   java.lang.Object lock
    jobject getLock() const {
       return mJniEnv->GetObjectField(mJavaObjectReference, sField_lock_6);

   }
    // field:   java.lang.Object lock
    void setLock(jobject lock) const {
        mJniEnv->SetObjectField(mJavaObjectReference, sField_lock_6, lock);
    }

    // field: static  int staticCount
    jint getStaticCount() const {
       return mJniEnv->GetStaticIntField(sClazz, sField_staticCount_7);

   }
    // field: static  int staticCount
    void setStaticCount(jint staticCount) const {
        mJniEnv->SetStaticIntField(sClazz, sField_staticCount_7, staticCount);
    }
