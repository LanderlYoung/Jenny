...
#define JENNY_CHECK_NULL(val)                      \
    ...
    if (!sInited) {
        ...
        if (!sInited) {
            ...
            sField_count_2 = env->GetFieldID(sClazz, "count", "I");
            JENNY_CHECK_NULL(sField_count_2);

            sField_staticName_3 = env->GetStaticFieldID(sClazz, "staticName", "Ljava/lang/String;");
            JENNY_CHECK_NULL(sField_staticName_3);

            sField_aStaticField_4 = env->GetStaticFieldID(sClazz, "aStaticField", "Ljava/util/List;");
            JENNY_CHECK_NULL(sField_aStaticField_4);

            sField_name_5 = env->GetFieldID(sClazz, "name", "Ljava/lang/String;");
            JENNY_CHECK_NULL(sField_name_5);

            sField_lock_6 = env->GetFieldID(sClazz, "lock", "Ljava/lang/Object;");
            JENNY_CHECK_NULL(sField_lock_6);

            sField_staticCount_7 = env->GetStaticFieldID(sClazz, "staticCount", "I");
            JENNY_CHECK_NULL(sField_staticCount_7);
...
jmethodID CallbackProxy::sMethod_onJobDone_2;
jmethodID CallbackProxy::sMethod_onJobProgress_3;

jfieldID CallbackProxy::sField_ANOTHER_COMPILE_CONSTANT_INT_0;
jfieldID CallbackProxy::sField_COMPILE_CONSTANT_INT_1;
jfieldID CallbackProxy::sField_count_2;
jfieldID CallbackProxy::sField_staticName_3;
jfieldID CallbackProxy::sField_aStaticField_4;
jfieldID CallbackProxy::sField_name_5;
jfieldID CallbackProxy::sField_lock_6;
jfieldID CallbackProxy::sField_staticCount_7;
